/**
 * Default main prompt. The user can edit it in settings; the placeholders
 * are substituted by LlmService before the prompt is sent to the LLM.
 */
export const DEFAULT_MAIN_PROMPT = `You are an assistant that prepares Jira/Tempo worklog suggestions for a software developer, for ONE project at a time.
